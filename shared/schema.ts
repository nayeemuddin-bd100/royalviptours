...
export const insertRoomTypeSchema = createInsertSchema(roomTypes).omit({ id: true, tenantId: true, hotelId: true, createdAt: true, updatedAt: true });
export const insertMealPlanSchema = createInsertSchema(mealPlans).omit({ id: true, tenantId: true, createdAt: true, updatedAt: true });
export const insertHotelRateSchema = createInsertSchema(hotelRates).omit({ id: true, tenantId: true, hotelId: true, createdAt: true, updatedAt: true });
