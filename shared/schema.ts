...
export const insertRoomTypeSchema = createInsertSchema(roomTypes).omit({ id: true, tenantId: true, createdAt: true, updatedAt: true });
export const insertMealPlanSchema = createInsertSchema(mealPlans).omit({ id: true, tenantId: true, createdAt: true, updatedAt: true });
export const insertHotelRateSchema = createInsertSchema(hotelRates).omit({ id: true, tenantId: true, createdAt: true, updatedAt: true });
export const insertTourGuideSchema = createInsertSchema(tourGuides).omit({ id: true, tenantId: true, createdAt: true, updatedAt: true });
export const insertSightSchema = createInsertSchema(sights).omit({ id: true, tenantId: true, createdAt: true, updatedAt: true });
export const insertItinerarySchema = createInsertSchema(itineraries).omit({ id: true, tenantId: true, createdAt: true, updatedAt: true });
export const insertItineraryEventSchema = createInsertSchema(itineraryEvents).omit({ id: true, tenantId: true, createdAt: true, updatedAt: true });
